...
const TourCard = ({ tour, showCurrencySymbol = true }) => {
  ...
  return (
    <Link to={`/tour/${tour.id}`} className="bg-white rounded-xl shadow-md overflow-hidden flex flex-col transform hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
        ...
        <div className="flex items-center justify-between mt-1 pt-1 border-t border-gray-100">
          <div className="leading-tight">
            <span className="text-base font-bold text-blue-600">
              {formatCurrency(tour.price, showCurrencySymbol)}
            </span>
